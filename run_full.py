#!/usr/bin/env python3
"""Run the complete English and Chinese datasets with all kernel fusions enabled."""
...
DATASETS = (
    ("English", Path("datasets/mmbench/mmbench_dev_en.tsv"), Path("fused_full_en.json")),
    ("Chinese", Path("datasets/mmbench/mmbench_dev_cn.tsv"), Path("fused_full_cn.json")),
)
